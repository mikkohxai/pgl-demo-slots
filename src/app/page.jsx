...
<p style={{fontSize:15,color:T.tb2,lineHeight:"24px"}}>6 interactive prototypes covering the complete advisor journey. Click any card to open.</p>
<div style={{display:"flex",gap:32,marginTop:20,paddingTop:16,borderTop:"1px solid "+T.brdB}}>
{[["6","prototypes"],["15","quiz questions"],["500","advisor seats"],["Apr 10","ship date"]].map(function(s,i){return <div key={i}><p style={{fontSize:24,fontWeight:700,color:T.tb1}}>{s[0]}</p><p style={{fontSize:11,color:T.tb2}}>{s[1]}</p></div>;})}
</div>
</div>
...
<div style={{marginTop:24,padding:20,background:T.bg2,borderRadius:8}}><p style={{fontSize:13,color:T.t2}}>Slots 7-10 available for future prototypes.</p></div>
</main>
