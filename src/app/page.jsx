...
const SLOTS = [
  { id: 1, name: "ACT-23 Network Hero Map", status: "live", type: "Latest Prototype", description: "End-to-end Sprint 1 flow: Login → Quiz with live map → Network Map dashboard (60% hero) + community detail panel with enrichment fields. Glassmorphic nodes, 6 community categories, vertical layout.", version: "4.0.0", updated: "2026-04-07" },
  ...
  { id: 3, name: "Vertical Network Map Reveal", status: "live", type: "Feature Showcase", description: "Shaina-preferred vertical bubble layout. Progressive reveal animation after quiz completion. Community cards with enrichment fields and AI expansion prompts.", version: "1.0.0", updated: "2026-04-07" },
  { id: 4, name: "Action Calendar", status: "live", type: "Feature Showcase", description: "Month/week/day views. Google Calendar sync. Task cards with Plant/Grow/Convert phase badges, community color stripes, functional checkboxes. 12 tasks across Week 1-2.", version: "1.0.0", updated: "2026-04-07" },
]
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 20px", fontFamily: "'Lato', sans-serif" }}>
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 14, color: "#6B6966", lineHeight: 1.6 }}>1 production prototype + 3 feature showcases. <a href="/resources" style={{ color: "#534AB7", fontWeight: 600 }}>View all resources →</a></p>
      </div>
      ...
      <div style={{ textAlign: "center", padding: "16px 0", fontSize: 11, color: "#A8A5A0", marginTop: 12 }}>Last verified: April 7, 2026 · 4 slots active</div>
    </div>
  )
}
